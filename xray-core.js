...
function xrayApplyHierarchy(state) {
  ...
  (function() {
    ...
    if (_isCoex && _cxCore && _cxInner && _cxLbl) {
      ...
      var _cxFull = !!(state.ospfFull || _cxSt.has_full || _cxSt.neighbor_state === "Full" || _cxSt.ospf_neighbor_full);/*oss_ospf_neighbor_full[worker6 2026-09-03]: OSPF core も実OSPF Full で緑(Q14 init)*/
...
function _xrayDeAngleView(s) {
  try {
    ...
    if (typeof _XRAY_DE !== "undefined") _XRAY_DE.fwdArrowCol = (function(){var _rp=(window._lastXrayState&&window._lastXrayState.route_resolution&&window._lastXrayState.route_resolution.protocol)||"";return _rp==="ospf"?"#39ff14":_rp==="bgp"?"#a855f7":(_isBgpFwd?"#a855f7":"#39ff14");})()/*oss-coexist-bc*/;
...
function xrayRenderDeepEngine(config, activeTargetId) {
  ...
  if (typeof _XRAY_DE !== "undefined") _XRAY_DE.fwdArrowCol = (function(){var _rp=(window._lastXrayState&&window._lastXrayState.route_resolution&&window._lastXrayState.route_resolution.protocol)||"";return _rp==="ospf"?"#39ff14":_rp==="bgp"?"#a855f7":(isBgp?"#a855f7":"#39ff14");})()/*oss-coexist-bc*/;
  ...
  window.applyXrayState = function applyXrayState(s) {
    ...
    (function() {
      ...
      function _sideCoexist(el, iface, isEgress) {
        ...
        if (hasBgp) el.classList.add(bup ? "de-side-bgp" : "de-side-bgp-idle"); else if (ospf) el.classList.add("de-side-ospf-" + _xrayOspfBucket(ospf));
        if (hasBgp && ospf) el.classList.add("de-coexist", "de-coexist-" + _xrayOspfBucket(ospf));
